...
\section*{Equation assignment sequence for variable ${r_x}$}
...
\hline
\endlastfoot
2 &11 &- &\begin{eq}{{\ell}}{_{N}} :: \text{port variable}\end{eq} & \\
1 &1 &- &\begin{eq}{{\#}}{_{}} :: \text{port variable}\end{eq} & \\
0 &12 &1 &\begin{eq}{r_x} := \text{Instantiate}({{\ell}}{_{N}}, {{\#}}{_{}})\end{eq} & \\
