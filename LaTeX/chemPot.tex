...
\section*{Equation assignment sequence for variable ${{\mu}}{_{N, S}}$}
...
\hline
\endlastfoot
2 &18 &- &\begin{eq}{n}{_{N, S}} :: \text{port variable}\end{eq} & \\
1 &16 &- &\begin{eq}{U}{_{N}} :: \text{port variable}\end{eq} & \\
0 &21 &1 &\begin{eq}{\mu} := \frac{\partial{{U}{_{N}}}}{\partial{{n}{_{N, S}}}}\end{eq} & \\
