...
\endlastfoot
    ...
    \begin{eq}{{p^o}}{_{N}} := \text{Instantiate}({p}{_{N}}, {{\#}}{_{}})\end{eq} &
    \begin{lay}normed pressure\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
        \hyperlink{"v:148"}{ 134 }\hypertarget{"e:134"}{  } &
    \begin{eq}{{c^o}}{_{N, S}} := \text{Instantiate}({c}{_{N, S}}, {{\#}}{_{}})\end{eq} &
    ...
    \begin{eq}{{m^{v\star}}}{_{A}} := \text{Instantiate}({m}{_{A}}, {{\#}}{_{}})\end{eq} &
    \begin{lay}setpoint for measurement vector\end{lay} &
    \begin{lay}control\end{lay} \\
        \hyperlink{"v:158"}{ 145 }\hypertarget{"e:145"}{  } &
    \begin{eq}{{m^{m\star}}}{_{A, S}} := \text{Instantiate}({m}{_{A, S}}, {{\#}}{_{}})\end{eq} &
