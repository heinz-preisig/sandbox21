...
\endlastfoot
    ...
    \begin{eq}{H}{_{N}} := \int_{ {{t^o}}{_{}} }^{ {{t^e}}{_{}} } \, {{\dot{H}}}{_{N}} \enskip d\,{t}{_{}}  + {Ho}{_{N}}\end{eq} &
    \begin{lay}Enthalpy\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
    ...
    \begin{eq}{Ho}{_{N}} := \text{Instantiate}({H}{_{N}}, {{\#}}{_{}})\end{eq} &
    \begin{lay}initial enthalpy\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
        \hyperlink{"v:145"}{ 131 }\hypertarget{"e:131"}{  } &
    \begin{eq}{no}{_{N, S}} := \text{Instantiate}({n}{_{N, S}}, {{\#}}{_{}})\end{eq} &
