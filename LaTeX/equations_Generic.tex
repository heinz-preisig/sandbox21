...
\endlastfoot
    ...
    \begin{lay}reactions\end{lay} \\
        \hyperlink{"v:116"}{ 101 }\hypertarget{"e:101"}{  } &
    \begin{eq}{K^o}{_{K}} := \text{Instantiate}({I}{_{S}} \star \left({P}{_{N, K}} \star \left(\left( {t}{_{}} \right)^{-1} \, . \, \left( {V}{_{N}} \right)^{-1} \, . \, \left( {n}{_{N, S}} \right)^{-1}\right)\right), {{\#}}{_{}})\end{eq} &
    \begin{lay}Arrhenius frequency factor -- a strange construction\end{lay} &
    \begin{lay}reactions\end{lay} \\
        \hyperlink{"v:117"}{ 102 }\hypertarget{"e:102"}{  } &
    \begin{eq}{K}{_{N, K}} := {K^o}{_{K}} \, . \, exp(\left( -{E_a}{_{N, K}} \right) \, . \, \left( {R}{_{N}} \, . \, {T}{_{N, K}} \right)^{-1})\end{eq} &
    \begin{lay}raction "constant"\end{lay} &
    \begin{lay}reactions\end{lay} \\
\hline
\end{longtable}